...
**Cadrage** : v0.1 livré 2026-05-08, v0.2 livré 2026-05-11, **v0.3 Digi-Hackathon livré 2026-05-23** (event 20-22 mai 2026). v0.4 à cadrer (`/gsd-new-milestone`). MUST = non-négociable, SHOULD = bonus, COULD = V2.

---

## v0.3 Requirements — archivés 2026-05-23

Voir `milestones/v0.3-REQUIREMENTS.md`. Score : 8/9 satisfaits, DIGI-08 deferred v0.4.
