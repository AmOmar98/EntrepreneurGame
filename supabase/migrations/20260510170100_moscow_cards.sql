...
-- Livrable #4 'fiche-produit-plan-dev-v1' (cf seed_event_hackdays.sql 5.4).
-- 1 row = 1 carte. Position = (bucket, ord) dans (project, deliverable_template).
-- DnD client = @dnd-kit/core (D-04, plan 09). Server = CRUD + reorder.
--
-- Apply order : schema.sql -> triggers.sql -> rls.sql -> seed_event_hackdays.sql
