...
- **Structure missions Digi-Hackathon (post quick-260519-l1l)** : 7 missions, 15 deliverables (5 bonus). M1 L1 (Persona main + Design Thinking bonus), M2 L2 (Préparation 2A + Fiches 2B hard-blocked), M3 L3 (BMC), M4 L4 (Marché+MoSCoW+3 bonus), M5 L4 (Commercialisation+bonus 100users), M6 L5 (Unit Economics), M7 L5 (Techniques pitch + Pitch deck). Welcome Guide PDF désync (8 → 7 ateliers programmés) gérée hors-code par Omar coordination.
